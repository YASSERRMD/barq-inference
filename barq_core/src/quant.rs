...
impl QuantizationType {
    ...
    pub const fn block_size(&self) -> usize {
        match self {
            ...
            QuantizationType::IQ2_KS => 256,
            QuantizationType::IQ3_KS => 256,
            QuantizationType::IQ4_KS => 256,
            QuantizationType::Q4_K_R4 => 32,
    ...
    pub const fn bits(&self) -> f32 {
        match self {
            ...
            QuantizationType::IQ2_KS => 2.0,
            QuantizationType::IQ3_KS => 3.0,
            QuantizationType::IQ4_KS => 4.0,
            QuantizationType::Q4_K_R4 => 4.5,
    ...
    pub fn name(&self) -> &'static str {
        match self {
            ...
            QuantizationType::IQ2_KS => "iq2_ks",
            QuantizationType::IQ3_KS => "iq3_ks",
            QuantizationType::IQ4_KS => "iq4_ks",
            QuantizationType::Q4_K_R4 => "q4_k_r4",
    ...
    pub fn from_str(s: &str) -> Result<Self> {
        match s.to_lowercase().as_str() {
            ...
            "iq2_ks" => Ok(QuantizationType::IQ2_KS),
            "iq3_ks" => Ok(QuantizationType::IQ3_KS),
            "iq4_ks" => Ok(QuantizationType::IQ4_KS),
            "q4_k_r4" => Ok(QuantizationType::Q4_K_R4),
